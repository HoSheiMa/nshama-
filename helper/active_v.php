...
$q = "SELECT * FROM `active_v` WHERE `email`='$email'";
...
<div class="col text-center">
  ...
  <tbody>";
    while ($x = mysqli_fetch_array($r)) {
        ...
        $addhtml = "<tr>
      <td><a onclick=\"remove_me_from('$id', 'v')\"class='btn btn-danger text-white'>انسحاب</a> 
      <a href=\"../readmore_.php?q=$id&type=v\" class='btn btn-primary'>التفصيل</a></td>
      <td>$state</td>
      <td>$name</td>
    </tr>
   ";
