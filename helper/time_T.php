...
<div class="row text-center">
   ...
   <div class="row justify-content-md-center">
    ...
    <h2 class="col-sm-12 col-lg-3 col-xl-3  bg-white" style="padding:8px;">عدد الساعات التدريبة</h2></div>
   </div>
...
<div class="col text-center">
   ...
   <?php
    ...
    $q = "SELECT * FROM `active_t` WHERE `email`='$email' AND `state`='3'";
  ...
  <tbody>";
    while ($x = mysqli_fetch_array($r)) {
        $id_ = $x['id'];
        $q_ = "SELECT * FROM `trainers info` WHERE `id`='$id_'";
