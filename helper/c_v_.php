...
$q = "SELECT * FROM `c_v_` WHERE `email`='$email'";
...
<div class="row text-center">
   ...
   <div class="row justify-content-md-center">
    ...
    <h2 class="col-sm-12 col-lg-3 col-xl-3  bg-white" style="padding:8px;">شهادات الفرص </h2></h2></div>
   </div>
...
<div class="col text-center">
  ...
  <tbody>";
    while ($x = mysqli_fetch_array($r)) {
        ...
        $name = $x['name'];
        $addhtml = "<tr>
        <td><a href='{$x['img']}' target='_blank' class='btn btn-link'>
