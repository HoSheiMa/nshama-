...
<div class="container" style="margin-top:50px; margin-bottom: 50px; background-color: #fff; padding: 30px 30px 40px 30px; text-align:right; direction:rtl;">
        ...
        <img width=200 onclick="window.location.assign('<?php echo $helpsyntax; ?><?php echo $r_get['profile_img']; ?>')" src='<?php echo $helpsyntax; ?><?php echo $r_get['profile_img']; ?>'>
</div>
 <!-- <div class="form-group">
   <label for=""></label>
...
?>
      ...
      <?php 
        ...
        <img width=200  height=200 onclick="window.location.assign('<?php echo $helpsyntax; ?>assets/<?php echo $r_get['cv']; ?>')"  src='<?php echo $helpsyntax; ?>assets/<?php echo $r_get['cv']; ?>'>
                              <div class='dropdown-divider'></div>
