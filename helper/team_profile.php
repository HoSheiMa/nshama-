...
$q_ = "SELECT * FROM `teams_members` WHERE `team_email`='$email' AND `state`='1'";
$r_ = mysqli_query($c, $q_);
$r_2 = mysqli_query($c, $q_);

$member_team = $r_->num_rows;
$h__ = 0;
...
<body>
    ...
    <div class="container col-md-10" style="margin-top:50px; margin-bottom: 50px; background-color: #fff; padding-top: 30px;padding-bottom: 50px;">
        <div class="row" style="margin:15px;">
            <div class="col-md-4">
                <div class="bg-success text-center" style="color: #fff; font-size:2rem;padding-top:20px;">
                    <p style="margin-bottom:0; font-weight:bold;"> أعضاء الفريق</p>
                    <span><?php echo $member_team; ?></span>
                </div>
            </div>
            <div class="col-md-4">
                <div class="bg-primary text-center" style="color: #fff;font-size:2rem; padding-top:20px;">
                    <p style="margin-bottom:0; font-weight:bold;">ساعة تطوعية</p>
                    <span><?php echo $h__; ?></span>
                </div>
            </div>
            <div class="col-md-4">
                <div class="bg-danger text-center" style="color: #fff; font-size:2rem;padding-top:20px;">
                    <p style="margin-bottom:0; font-weight:bold;">طلبات الإنضمام</p>
                    <span><?php echo $r__->num_rows; ?></span>
                </div>
            </div>
        </div>
        <hr>
            ...
            <div class="col-md-6 col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title" style="text-align:center;">آخر الأعضاء المنضمين </h4>
                    </div>
                        ...
                        <table id="teamTable" class="table" style="margin-top: 20px; text-align:center;">
                            <tbody>
                                <tr>
                                    ...
                                    <th scope="row">تاريخ الإلتحاق</th>
                                </tr>
                                <?php

                                while ($x = mysqli_fetch_array($r_2)) {
