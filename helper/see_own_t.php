...
<div class="row text-center">
   ...
   <div class="row justify-content-md-center">
    ...
    <h2 class="col-sm-12 col-lg-3 col-xl-3  bg-white" style="padding:8px;">الدورات التدريبية</h2></div>
   </div>
...
الدورات المتاحة
  ...
  <tbody>
    ...
    <?php
    $gmail = $_SESSION['who'];
    $q = "SELECT * FROM `training_courses` WHERE `email`='$gmail' AND `state`='1'";
    $r = mysqli_query($c, $q);
    ...
    while ($x = mysqli_fetch_array($r)) {
      ...
      echo "
                ...
                <div class=\"btn-group\" role=\"group\" aria-label=\"Basic example\">
                    <button onclick='window.location.assign(\"../readmore_.php?q=$id&type=t\")' type=\"button\" class=\"btn btn-success\">التحكم</button>
                    <button onclick='actions__t(2,this,\"$id\",\"t\")' type=\"button\" class=\"btn \">اغلاق</button>
                    <button onclick='actions__t(3,this,\"$id\",\"t\")' type=\"button\" class=\"btn btn-danger\">مسح</button>
                    </div>
                </td>
                <td>$title</td>
                </tr>
...
الدورات المغلقة
  ...
  <tbody>
    ...
    <?php
    $gmail = $_SESSION['who'];
    $q = "SELECT * FROM `training_courses` WHERE `email`='$gmail' AND `state`='0'";
    $r = mysqli_query($c, $q);
    ...
    while ($x = mysqli_fetch_array($r)) {
      ...
      echo "
                ...
                <div class=\"btn-group\" role=\"group\" aria-label=\"Basic example\">
                    <button onclick='window.location.assign(\"../readmore_.php?q=$id&type=t\")' type=\"button\" class=\"btn btn-success\">التحكم</button>
                    <button onclick='actions__t(3,this,\"$id\")' type=\"button\" class=\"btn btn-danger\">مسح</button>
                    </div>
                </td>
                <td>$title</td>
                </tr>
