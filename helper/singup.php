...
<div id="form_contant" v-if="type != 0" class="row text-right " style="background-image:url(assets/bg.svg);    background-repeat: no-repeat; min-height : 80vh;padding:25px;">
    <form v-if="type == 1" class="text-right form_1" method="post" action="ajax/singup.php" enctype="multipart/form-data">
        ...
        <div class=row style="height:10px"></div> <input name="sname" class="form-control" placeholder="اسم الأب" type="text"
            required="" style="display:inline-block;">
        <div class=row style="height:10px"></div> <input name="tname" class="form-control" placeholder="اسم الجد" type="text"
            required="" style="display:inline-block;">

                   
            
        <div class=row style="height:10px"></div> <input name="lname" class="form-control" placeholder="اسم العائلة"
            type="text" required="" style="display:inline-block;">
            <input name="lname" class="form-control mt-2" placeholder="منطقة / محافظة"
            type="text" required="" style="display:inline-block;">
    <div class='dropdown-divider'></div>
        <div class=row style="height:10px"></div>
        <div class=row style="height:10px"></div> <input name="no" id="no" class="form-control" placeholder="رقم الهوية"
        onblur="checkId('user');" type="text" required="" style="display:inline-block;">
        <div class=row style="height:10px"></div> <input name="name" id="UserName" class="form-control" placeholder="اسم المستخدم"
             type="text" required="" style="display:inline-block;">
        <!-- <div id="id_status" class="checked" style="margin-right:230px">السجل المدني متاح</div> -->
        <div class=row style="height:10px"></div> <input name="pass" class="form-control" placeholder="كلمة المرور "
            type="password" required="" style="display:inline-block;">
        <div class=row style="height:10px"></div> <input name="cpass" class="form-control" placeholder=" تأكيد كلمة المرور"
            type="password" required="" style="display:inline-block;">
        ...
        <input name="date" class="form-control" placeholder=" تاريخ الميلاد "
            type="date" required="" style="display:inline-block;">
        <hr>
        <h5 style="text-align:right; color: #008ba3; margin-bottom:10px; margin-top:30px !important; margin-right: 15px;">
            معلومات الاتصال </h5>

            <div id="email_status" class="checked"> البريد الإلكتروني متاح</div>
        <div class=row style="height:10px"></div> <input name="email" id="email" class="form-control" placeholder="البريد الالكتروني"
            onblur="checkEmail('user');" type="email" required="">
            <div id="phone_status" class="checked"> رقم الجوال متاح</div>
        <div class=row style="height:10px"></div> <input name="phone" id="phone" class="form-control" placeholder="رقم الجوال"
            onblur="checkPhone('user');" type="text" required="">
        <div class=row style="height:10px"></div> <input name="telphone" class="form-control" placeholder="رقم الهاتف"
            type="text">
        <div class=row style="height:10px"></div> <input name="emr_phone" class="form-control" placeholder="رقم الطوارئ"
            type="text">
        ...
        <div class=row style="height:10px"></div> <input name="special" class="form-control" placeholder="التخصص" type="text"
            required="" style="display:inline-block;">
        ...
        <div class=row style="height:10px"></div> <input name="job_title" class="form-control" placeholder=" المسمى الوظيفي"
            type="text" required="" style="display:inline-block;">
        <div class=row style="height:10px"></div> <input name="job_place" class="form-control" placeholder=" جهة العمل"
            type="text" required="" style="display:inline-block;">
        <hr>
        <h5 style="text-align:right; color: #008ba3; margin-bottom:10px; margin-top:30px !important; margin-right: 15px;">
            معلومات التطوّع </h5>
        ...
        <div class=row  style="height:10px"></div> <select  name="expir" id='expir' required="" 
        onchange="expir11(event)" class="form-control" style="display:inline-block;">
            ...
            <option>لا</option>
             ...
             <div class=row style="height:10px"></div> <input name="profile_img" class="form-control" placeholder="اسم الجد" type="file"
            required="" style="display:inline-block;">
    <div class='dropdown-divider'></div>
         <div id="name_status" class="checked" style="margin-right:50px">صورة الأحوال / الإقامة  </div>

             <div class=row style="height:10px"></div> <input name="id_img" class="form-control" placeholder="اسم الجد" type="file"
            required="" style="display:inline-block;">
    <div class='dropdown-divider'></div>
...
?>
    ...
    <form v-if="type == 2" class="text-right form_1" method="post" action="ajax/singup.php" enctype="multipart/form-data">
        ...
        <h5 style="text-align:right; color: #008ba3; margin-bottom:10px; margin-top:30px !important; margin-right: 15px;">المعلومات
            الشخصية</h5>
        <div class=row style="height:10px;"></div> <input name="fname" class="form-control" placeholder="الاسم الأول"
            type="text" required="" style="display:inline-block;">
        <div class=row style="height:10px;"></div> <input name="sname" class="form-control" placeholder="اسم الأب" type="text"
            required="" style="display:inline-block;">
        <div class=row style="height:10px;"></div> <input name="tname" class="form-control" placeholder="اسم الجد" type="text"
        ...
        تاريخ الميلاد
        <div class=row style="height:10px;"></div> <input name="date" class="form-control" placeholder=" تاريخ الميلاد "
            type="date" required="" style="display:inline-block;">
        <hr>
        <h5 style="text-align:right; color: #008ba3; margin-bottom:10px; margin-top:30px !important; margin-right: 15px;">
            معلومات الاتصال </h5>
        <div class=row style="height:10px;"></div> <input name="email" class="form-control" placeholder="البريد الالكتروني"
            type="email" required="">
        <div class=row style="height:10px;"></div>
        <div class=row style="height:10px;"></div> <input name="phone" class="form-control" placeholder="رقم الجوال"
            type="text" required="">
        <div class=row style="height:10px;"></div> <input name="telphone" class="form-control" placeholder="رقم الهاتف"
            type="text">
        <div class=row style="height:10px;"></div> <input name="emr_phone" class="form-control" placeholder="رقم الطوارئ"
    ...
    <form v-if="type == 3" class="text-right form_1" method="post" action="ajax/singup.php" enctype="multipart/form-data">
        ...
        <h5 style="text-align:right; color: #008ba3; margin-bottom:10px; margin-top:30px !important; margin-right: 15px;">البيانات
            الأساسية</h5>
        <input name="name" class="form-control placeholder-right" placeholder="اسم الفريق" type="text" required=""
        ...
        <textarea name="about" required="" class="form-control placeholder-right" rows="3" maxlength="140" placeholder="نبذة عن الفريق"
            style="display:inline-block;width: 95%;"></textarea>
        <div style="padding:10px 60px;" class="border border-primary rounded">
            <input type="checkbox" name="track[]" id="boxtm-1" value="1"><label for="boxtm-1"> إداري</label> <input
                type="checkbox" name="track[]" id="boxtm-2" value="2"><label for="boxtm-2"> إعلامي</label> <input type="checkbox"
                name="track[]" id="boxtm-3" value="3"><label for="boxtm-3"> صحي</label> <input type="checkbox" name="track[]"
                id="boxtm-4" value="4"><label for="boxtm-4"> اجتماعي</label> <input type="checkbox" name="track[]" id="boxtm-5"
                value="5"><label for="boxtm-5"> تقني</label> <input type="checkbox" name="track[]" id="boxtm-6" value="6"><label
                for="boxtm-6"> أدبي</label> <input type="checkbox" name="track[]" id="boxtm-7" value="7"><label for="boxtm-7">
                ترفيهي</label> <input type="checkbox" name="track[]" id="boxtm-8" value="8"><label for="boxtm-8"> ثقافي</label>
            <input type="checkbox" name="track[]" id="boxtm-9" value="9"><label for="boxtm-9"> رياضي</label> <input
                type="checkbox" name="track[]" id="boxtm-10" value="10"><label for="boxtm-10"> إغاثي</label> <input
                type="checkbox" name="track[]" id="boxtm-11" value="11"><label for="boxtm-11"> قانوني</label> <input
                type="checkbox" name="track[]" id="boxtm-12" value="12"><label for="boxtm-12"> تدريبي</label> <input
                type="checkbox" name="track[]" id="boxtm-13" value="13"><label for="boxtm-13"> هندسي</label> <input
                type="checkbox" name="track[]" id="boxtm-14" value="14"><label for="boxtm-14"> تنظيمي</label>
        </div>
        <h5 style="text-align:right; color: #008ba3; margin-bottom:10px; margin-top:30px !important; margin-right: 15px;">
            معلومات الاتصال </h5>
    ...
    <form v-if="type == 4" class="text-right form_1" method="post" action="ajax/singup.php" enctype="multipart/form-data">
        ...
        <div class=row style="height:10px;"></div><input name="pass" class="form-control" placeholder="كلمة المرور"
            type="password" required="" style="display:inline-block;">
        <div class=row style="height:10px;"></div> <input name="cpass" class="form-control" placeholder="تأكيد كلمة المرور"
            type="password" required="" style="display:inline-block;"><br>
        <div class=row style="height:10px;"></div> <input name="address" class="form-control" placeholder="عنوان الجهة المستفيدة"
            type="text" required="" style="display:inline-block;width: 50%;">
        <div class=row style="height:10px;"></div> <input name="email" class="form-control" placeholder="البريد الالكتروني"
            type="text" required="">
        <div class=row style="height:10px;"></div> <textarea name="about" required="" class="form-control" rows="3"
            maxlength="140" placeholder="نبذة عن الجهة المستفيدة" style="display:inline-block;width: 95%;"></textarea>
        <hr>
        <h5 style="text-align:right; color: #008ba3; margin-bottom:10px; margin-top:30px !important; margin-right: 15px;">بيانات
            مسؤولي الجهة </h5>
        <div class=row style="height:10px;"></div> <input name="officer" class="form-control" placeholder="اسم المنسق"
            type="text" required="" style="display:inline-block;">
        <div class=row style="height:10px;"></div> <input name="ophone" class="form-control" placeholder="جوال المنسق"
            type="text" required="" style="display:inline-block;">
        <div class=row style="height:10px;"></div> <input name="owork" class="form-control" placeholder="عمله في الجهة"
            type="text" required="" style="display:inline-block;">
        <div class=row style="height:10px;"></div> <input name="oemail" class="form-control" placeholder=" بريده الإلكتروني"
            type="email" required="" style="display:inline-block;">
        <div class=row style="height:10px;"></div> <input name="request_name" class="form-control" placeholder="اسم مقدم الطلب"
            type="text" required="" style="display:inline-block;">
        <div class=row style="height:10px;"></div> <input name="request_phone" class="form-control" placeholder="جوال مقدم الطلب"
            type="text" required="" style="display:inline-block;">
        <div class=row style="height:10px;"></div> <input name="request_id" class="form-control" placeholder=" رقم هوية مقدم الطلب"
            type="text" required="" style="display:inline-block;">
        <hr>
           <h6 style="text-align:right;margin-bottom:10px; margin-top:30px !important; margin-right: 15px;">
